(function() {
    ...
    var areaEffect = merge(base, verticalEffect, rangeSlider);

    var horizontalareaEffect = merge(base, horizontalEffect, rangeSlider);
    ...
    var infoRadarEffect = merge(base, rangeSlider, {
        plotArea: {
            gridline: {
                color: axisGridlineColor
            },
    ...
    var bulletEffect = merge(legend, background, plotArea, {
        valueAxis:{
            title:{
                visible:true
            }
    ...
    var trellisBulletEffect = merge(bulletEffect, {plotArea:{
        gridline:{
            visible:false
        }
    }});
    ...
    sap.viz.extapi.env.Template.register({
        ...
        properties: {
            ...
            'info/trellis_area' : info(areaEffect),
            'info/trellis_horizontal_area' : info(horizontalareaEffect),
            'info/trellis_100_horizontal_area' : info(horizontalareaEffect),
            'info/trellis_100_area' : info(areaEffect),
            ...
            'info/trellis_dual_stacked_column': infoDual(dualstackedverticalbarEffect),
            'info/trellis_dual_stacked_bar': infoDual(dualstackedbarEffect),
            'info/trellis_100_dual_stacked_column':infoDual(dualstackedverticalbarEffect),
            'info/trellis_100_dual_stacked_bar': infoDual(dualstackedbarEffect),
            ...
            'info/trellis_radar': infoRadar(infoRadarEffect)
        },

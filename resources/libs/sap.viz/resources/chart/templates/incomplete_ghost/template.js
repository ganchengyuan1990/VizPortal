(function() {
    ...
    var ghost_properties_info_heatmap = merge(base, xxEffect);
    ...
    sap.viz.extapi.env.Template.register({
        ...
        properties: {
            ...
            'info/haetmap': infoHeatmap(ghost_properties_info_heatmap),
            ...
            'info/trellis_100_dual_stacked_column':infoDual(ghost_properties_horizontal_stackedbar),
            'info/trellis_100_dual_stacked_bar': infoDual(ghost_properties_vertical_stackedbar),

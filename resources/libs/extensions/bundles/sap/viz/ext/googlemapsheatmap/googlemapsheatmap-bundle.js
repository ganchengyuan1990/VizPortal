define("googlemapsheatmap-bundle", ["sap_viz_ext_googlemapsheatmap-src/js/flow", "css!sap_viz_ext_googlemapsheatmap-src/style/default.css"], function(flowDefinition, cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "instance" : vizExtImpl,
            "customProperties" : {
                "name" : "sap.viz.ext.googlemapsheatmap",
                "description" : "",
                "icon" : {"path" : ""},
                "category" : [],
                "requires": [{
                ...
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_googlemapsheatmap-src/resources/templates"}]
            }
        }]
   });

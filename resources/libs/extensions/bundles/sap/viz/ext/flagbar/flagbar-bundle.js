define("flagbar-bundle", ["sap_viz_ext_flagbar-src/js/flow", "css!sap_viz_ext_flagbar-src/style/default.css"], function(flowDefinition, cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_flagbar-src/resources/templates"},
                                {"key": "sap.viz.ext.flagbar.ImgLoadPath", "path": "./sap_viz_ext_flagbar-src/resources/img/"}]
            }
        }]
   });

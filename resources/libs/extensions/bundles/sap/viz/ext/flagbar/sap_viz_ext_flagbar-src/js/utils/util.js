...
define("sap_viz_ext_flagbar-src/js/utils/util", [], function(){
    /*
    ...
    var _util = {/*__FOLD__*/
        ...
        */
        ...
        _toFlatJsonArray : function(measureSets, dimSets) {
            ...
            for (var i = 0; i < measure0Data.length; i++) {
                for (var j = 0; j < measure0Data[i].length; j++) {
                    var datum = {};
                    ...
                    $.each(measureSets, function(idx, measureSet) {
                        ...
                        for (var n = 0; n < measureSet.length; n++) {
                            var measure = measureSet[n];

define("gauge-bundle", ["sap_viz_ext_gauge-src/js/flow", "css!sap_viz_ext_gauge-src/style/default.css"], function(flowDefinition, cssStyleDeclaration) {
    ...
    var vizExtBundle = sap.bi.framework.declareBundle({
        ...
        "components" : [{
            ...
            "customProperties" : {
                ...
                "resources" : [{"key":"sap.viz.api.env.Template.loadPaths", "path":"./sap_viz_ext_gauge-src/resources/templates"}]
            }
        }]
   });

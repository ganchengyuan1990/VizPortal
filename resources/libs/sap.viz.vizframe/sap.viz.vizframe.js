...
// @formatter:on
    ...
    ['data', 'bindings', 'properties', 'scales', 'customizations', 'template'].forEach(function(name) {
        (function(name) {
    ...
    ['selection', 'propertyZone', 'feedingZone', 'size'].forEach(function(name) {
        (function(name) {
            Viz.prototype[name] = function() {
                if (this._vizInstance) {
...
// @formatter:on
    ...
    // @formatter:off
    ['data', 'bindings', 'properties', 'scales', 'customizations', 'template', 'size',
        'update', 'selection', 'propertyZone', 'feedingZone', 'on', 'off'].forEach(function(name) {
    // @formatter:on
        (function(name) {

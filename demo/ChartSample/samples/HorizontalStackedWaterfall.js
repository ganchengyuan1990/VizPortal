define(["./../util/data/Data_horizontal_stacked_waterfall", "./../util/binding/Bind_horizontal_stacked_waterfall", "./../util/property/Common_Property"], function(Data, Binding, Property) {
    return {

$(function(){
    ...
    sap.viz.api.env.Template.set("standard_lumira",function(){
        ...
        var choropleth = new sap.viz.geo.dataviz.Choropleth({
            colorPalette: ["green", "yellow", "orange"],
            legendValues:[0, 60, 80, 100],
            numOfSegments: 3
        });
        var delJS=['main_color.js'];
        var delCss=['style.css'];
        var delElementById=['setting','code-content','toggle','code'];
        toggleViewExtension("index_color.html","main_color.js",textArea,delJS,delCss,delElementById);
        // create a layer

$(function() {
    ...
    sap.viz.api.env.Template.set('standard_lumira', function() {
        ...
        var delJS=['listenSelectData.js','jquery-ui'];
        var delCss=['button.css'];
        var delElementById=['setting','code-content','toggle','code'];
         toggleViewExtension("index.html","listenSelectData.js",textArea,delJS,delCss,delElementById);
        //Add event listener for selectData
        vizFrame.on('selectData', function(event) {
            alert('selectData');
        });

        //Remove event listener for selectData
        //vizFrame.off('selectData');
    });
